...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ComponentName widget = new ComponentName(this, TodoListWidget.class);
        manager.notifyAppWidgetViewDataChanged(manager.getAppWidgetIds(widget), R.id.widget_list_view);*/
