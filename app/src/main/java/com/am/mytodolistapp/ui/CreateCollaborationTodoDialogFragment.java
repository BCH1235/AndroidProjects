...
public class CreateCollaborationTodoDialogFragment extends DialogFragment {
    ...
    public static CreateCollaborationTodoDialogFragment newInstance(String projectId) {
        CreateCollaborationTodoDialogFragment fragment = new CreateCollaborationTodoDialogFragment();
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.dialog_create_collaboration_todo, container, false);
    }
    ...
    private void setupClickListeners() {
        ...
        buttonCreate.setOnClickListener(v -> {
            ...
            CollaborationTodoItem newTodo = new CollaborationTodoItem(title, projectId,
                    viewModel.getCurrentUserId(), viewModel.getCurrentUserName());
            ...
            // 우선순위 설정
            newTodo.setPriority(spinnerPriority.getSelectedItemPosition() + 1);
            ...
            if (assigneePosition > 0 && !projectMembers.isEmpty()) {
                ...
                newTodo.setAssignedToId(assignee.getUserId());
                newTodo.setAssignedToName(assignee.getUserName());
            }

            // 기한 설정
            if (checkBoxSetDueDate.isChecked() && selectedDueDate != null) {
                newTodo.setDueDate(selectedDueDate.getTimeInMillis());
            }

            buttonCreate.setEnabled(false);
            viewModel.createTodo(newTodo, new CollaborationViewModel.CreateTodoCallback() {
                @Override
                public void onSuccess(String todoId) {
                ...
                public void onError(String error) {
                    ...
                    Toast.makeText(getContext(), "할일 추가 실패: " + error, Toast.LENGTH_LONG).show();
                }
            });
        });
    }
